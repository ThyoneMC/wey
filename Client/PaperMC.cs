...
namespace wey.Client
{
    class PaperMC
    {
        ...
        public static Task<ProjectName?> GetProjects()
        {
        ...
        public static Task<Project?> GetProject(string project)
        {
        ...
        public static Task<Build?> GetBuilds(string project, string version)
        {
        ...
        public static Task<byte[]?> Download(string project, string version, string build, string download)
        {
